...
$(function($){
    ...
    $('.datatable').DataTable({ 
        ...
        buttons: [  
            {extend: 'copy', className: 'btn-sm prints', text: 'Copiar'}, 
            {extend: 'csv', title: 'Arquivo CSV', className: 'btn-sm prints', text: 'CSV'}, 
            {extend: 'excel', title: 'Arquivo Excel', className: 'btn-sm prints', text: 'Excel'}, 
            {extend: 'pdf', title: 'Arquivo PDF', className: 'btn-sm prints', text: 'PDF'}, 
            {extend: 'print', className: 'btn-sm prints', text: 'Imprimir'} 
        ], 
        "language": {
...
$(document).ready(function() { 
   ...
   var invoicedatatable = $('#InvList').DataTable({ 
    ...
    'lengthMenu': [[10, 25, 50, 100, 250, 500, total_invoice], [10, 25, 50, 100, 250, 500, "Todos"]],
    ...
    buttons: [
        ...
        {
            extend: "print",
            title: "<center>Lista de Faturas</center>",
            exportOptions: { columns: [0, 1, 2, 3, 4, 5] },
            className: "btn-sm prints"
        }
    ],
...
$(document).ready(function() { 
   ...
   var total_stock = $("#total_stock").val();
    ...
    'processing': true,
    'serverSide': true,
    'lengthMenu': [[10, 25, 50, 100, 250, 500, total_stock], [10, 25, 50, 100, 250, 500, "Todos"]],
    
    dom: "'<'col-sm-4'l><'col-sm-4 text-center'><'col-sm-4'>Bfrtip", 
    buttons: [ 
        { extend: "copy", className: "btn-sm prints" },
        { extend: "csv", title: "Lista de Estoque", className: "btn-sm prints" },
        { extend: "excel", title: "Lista de Estoque", className: "btn-sm prints" },
        { extend: "pdf", title: "Lista de Estoque", className: "btn-sm prints" },
        { extend: "print", title: "<center>Lista de Estoque</center>", className: "btn-sm prints" }
    ],
    ...
    "footerCallback": function(row, data, start, end, display) {
        var api = this.api();
        api.columns('.stock', { page: 'current' }).every(function() {
            var sum = this.data().reduce(function(a, b) {
                var x = parseFloat(a) || 0;
                var y = parseFloat(b) || 0;
                return x + y;
        ...
        api.columns('.total_purchase', { page: 'current' }).every(function() {
            var sum = this.data().reduce(function(a, b) {
                var x = parseFloat(a) || 0;
                var y = parseFloat(b) || 0;
                return x + y;
...
$(document).ready(function() { 
   ...
   var base_url  = $('#base_url').val();
    ...
    buttons: [
        { extend: "copy", className: "btn-sm prints" },
        { extend: "csv", title: "Lista de Clientes com Crédito", className: "btn-sm prints" },
        { extend: "excel", title: "Lista de Clientes com Crédito", className: "btn-sm prints" },
        { extend: "pdf", title: "Lista de Clientes com Crédito", className: "btn-sm prints" },
        { extend: "print", title: "<center>Lista de Clientes com Crédito</center>", className: "btn-sm prints" }
    ],
    'serverMethod': 'post',
    'ajax': {
