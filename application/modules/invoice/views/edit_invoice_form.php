...
<div class="row">
                            ...
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="paytype" class="form-control" required="" onchange="toggleBoletoFieldEdit(this.value)" tabindex="3">
                            ...
                            <div id="boleto_vencimento_edit" style="display:none;">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="boleto_due_date" class="form-control" value="<?php echo isset($boleto_due_date) ? $boleto_due_date : ''; ?>" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="delivery_location" name="delivery_location" tabindex="2" value="<?php echo $delivery_location; ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="invoice_seller" name="invoice_seller" value="<?php echo $invoice_seller; ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
 ...
 <tfoot>
                                ...
                                <textarea name="observation" id="observation" class="form-control" placeholder="<?php echo display('observation') ?>"><?php echo $observation;?></textarea>
                                </td>
