                ...
                <div style="display: flex;">
                    <div style="width: 50%;">
                        ...
                        <address class="margin-top10">
                          ...
                          <?php }?>
                            <abbr><b><?php echo display('seller') ?>:</b> <?php echo $seller;?></abbr>
                        </address>
                    ...
                    <div style="width: 50%;">
                        ...
                        <?php if (!empty($boleto_due_date)) { ?>
                            <div class="m-b-15">Data de Vencimento do Boleto: <?php echo $boleto_due_date;?></div>
                        <?php } ?>
                        <div class="m-b-15"><?php echo display('billing_date') ?>: <?php echo date("d-M-Y",strtotime($final_date));?></div>
    
                        <span class="label label-success-outline m-r-15"><?php echo display('billing_to') ?></span>
    
                        <address class="customer_name_p" style="width: 100%;">  
                            <strong class="c_name"><?php echo $customer_name?> </strong><br>
                            <?php if ($customer_address) { ?>
                                <div class="m-b-15"><?php echo $customer_address;?></div>
                            <?php } ?>
                            <?php if ($customer_address_zip) { ?>
                                <div class="m-b-15"><?php echo $customer_address_zip;?></div>
                            <?php } ?>
                            <br>
                            ...
                            <?php }if ($customer_email) {
                                ...
                                <br>
                            <?php } ?>
                            <abbr><br><b><?php echo display('customer_cod') ?>:</b> <?php echo $customer_code;?></abbr><br>
