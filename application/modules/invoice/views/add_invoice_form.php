                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6" id="payment_from">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="paytype" class="form-control" required="" onchange="toggleBoletoField(this.value)" tabindex="3">
                            ...
                            <div id="boleto_vencimento" style="display:none;">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="boleto_due_date" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="delivery_location" name="delivery_location" tabindex="2" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="invoice_seller" name="invoice_seller" value="<?php echo $this->session->userdata('fullname') ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td  class="invoice_fields">
                                             <select class="form-control" id="serial_no_1" name="serial_no[]"   tabindex="7" disabled>
                                                <option></option>
                                            </select>
                                        </td>
                                        <td>
