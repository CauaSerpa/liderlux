                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php }?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="serial_no" class="col-sm-4 col-form-label"><?php echo display('serial_no') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control " id="serial_no" name="serial_no" placeholder="111,abc,XYz"  value="<?php echo $product->serial_no?>" required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="table" class="col-sm-4 col-form-label"><?php echo display('table') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                        <select class="form-control" id="table" name="table" tabindex="-1" aria-hidden="true">
                                            <option value="">Select One</option>
                                            <option value="SP" <?php if($product->table == 'SP'){echo 'selected';}?>><?php echo display('total_product_table_sp')?></option>
                                            <option value="RJ" <?php if($product->table == 'RJ'){echo 'selected';}?>><?php echo display('total_product_table_rj')?></option>
                                            <option value="BR" <?php if($product->table == 'BR'){echo 'selected';}?>><?php echo display('total_product_table_br')?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    foreach ($taxfield as $taxss) {?>
                       ...
                       <?php $i++;}?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="price_sp" class="col-sm-4 col-form-label">Preço SP</label>
                                    <div class="col-sm-8">
                                        <input class="form-control text-right" id="price_sp" name="price_sp" type="text" placeholder="0.00" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="price_rj" class="col-sm-4 col-form-label">Preço RJ</label>
                                    <div class="col-sm-8">
                                        <input class="form-control text-right" id="price_rj" name="price_rj" type="text" placeholder="0.00" min="0">
                                    </div>
                                </div> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="price_br" class="col-sm-4 col-form-label">Preço BR</label>
                                    <div class="col-sm-8">
                                        <input class="form-control text-right" id="price_br" name="price_br" type="text" placeholder="0.00" min="0">
                                    </div>
                                </div> 
                            </div>
                        </div>
                        
                        <small><i class="text-danger"></i> Pelo menos um dos valores é obrigatório.</small>
