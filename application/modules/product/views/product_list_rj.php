         ...
         <?php if($this->permission1->method('add_product_csv','create')->access()){ ?>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="productListRJ"> 
                                <thead>
                                    <tr>
    ...
    var total_product = $("#total_product").val();
     $('#productListRJ').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, total_product], [10, 25, 50,100,250,500, "All"]],
            ...
            , {
                extend: "csv", title: "ProductListRJ",exportOptions: {
            ...
            , {
                extend: "excel",exportOptions: {
                       columns: [ 0, 1, 2, 3, 4,5 ] //Your Colume value those you want print
                           }, title: "ProductListRJ", className: "btn-sm prints"
            }
            , {
            ...
            , {
                extend: "print",exportOptions: {
                       columns: [ 0, 1, 2, 3, 4,5 ] //Your Colume value those you want print
                           },title: "<center>ProductListRJ</center>", className: "btn-sm prints"
            }
            ],
            
            'serverMethod': 'post',
            'ajax': {
               'url': base_url + 'product/product/CheckProductListRJ',
               data:{
