...
class Product_model extends CI_Model {
     ...
     public function update_product($data = [])
    {
       ...
       public function getProductList($postData=null){
         ...
         $this->db->where("a.table", "LIDERLUX");
          if($searchValue != '')
      ...
      if($this->permission1->method('manage_product','update')->access()){
       ...
       public function getProductListSP($postData=null){
         ...
         $this->db->join('supplier_product c','c.product_id = a.product_id','left');
         $this->db->join('supplier_information m','m.supplier_id = c.supplier_id','left');
         $this->db->where("m.supplier_id", 1);
         $this->db->where("`a`.`table`", "SP");
          if($searchValue != '')
         $this->db->where($searchQuery);
         $records = $this->db->get()->result();
         $totalRecords = $records[0]->allcount;
      ...
      if($this->permission1->method('manage_product','update')->access()){
       ...
       public function getProductListRJ($postData=null){
         ...
         $this->db->join('supplier_product c','c.product_id = a.product_id','left');
         $this->db->join('supplier_information m','m.supplier_id = c.supplier_id','left');
         $this->db->where("m.supplier_id", 2);
         $this->db->where("a.table", "RJ");
          if($searchValue != '')
         $this->db->where($searchQuery);
         $records = $this->db->get()->result();
         $totalRecords = $records[0]->allcount;
      ...
      if($this->permission1->method('manage_product','update')->access()){
       ...
       public function getProductListBR($postData=null){
         ...
         $this->db->join('supplier_product c','c.product_id = a.product_id','left');
         $this->db->join('supplier_information m','m.supplier_id = c.supplier_id','left');
         $this->db->where("m.supplier_id", 3);
         $this->db->where("a.table", "BR");
          if($searchValue != '')
         $this->db->where($searchQuery);
         $records = $this->db->get()->result();
         $totalRecords = $records[0]->allcount;
