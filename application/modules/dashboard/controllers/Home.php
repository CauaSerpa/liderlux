...
class Home extends MX_Controller {
    ...
    'total_customer' => ($this->session->userdata('isAdmin') == 1) 
        ? $this->db->count_all('customer_information') 
        : $this->db->where('create_by', $this->session->userdata('id'))->count_all_results('customer_information'),
    'total_product'        => $this->db->where('table', 'LIDERLUX')->count_all_results('product_information'),
    'total_product_sp'     => $this->db->where('table', 'SP')->count_all_results('product_information'),
    'total_product_rj'     => $this->db->where('table', 'RJ')->count_all_results('product_information'),
    'total_product_br'     => $this->db->where('table', 'BR')->count_all_results('product_information'),
