                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="">
                                            ...
                                            <input type="text" name="document" class="form-control input-mask-trigger text-left" id="document" placeholder="<?php echo display('cpf_cnpj')?>" maxlength="18" value="<?php echo $customer->document?>" data-inputmask="'alias': 'decimal', 'groupSeparator': '', 'autoGroup': true" im-insert="true">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="">
                                          ...
                                          <input class="form-control"  id="customer_address" type="text" name="customer_address" placeholder="<?php echo display('address')?>" value="<?php echo $customer->contact?>">
