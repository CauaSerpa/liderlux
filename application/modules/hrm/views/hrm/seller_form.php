        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="form-group row">
                         <label for="phone" class="col-sm-2 col-form-div"><?php echo display('mobile_phone') ?></label>
                        <div class="col-sm-4">
                            <input name="phone" class="form-control" type="number" placeholder="<?php echo display('mobile_phone') ?>" id="phone" value="<?php echo $employee->phone?>">
                        </div>
