...
/*seller part*/
$route['seller_form']           = "hrm/hrm/bdtask_seller_form";
$route['seller_form/(:num)']    = 'hrm/hrm/bdtask_seller_form/$1';
$route['seller_list']           = 'hrm/hrm/bdtask_seller_list';
$route['seller_profile/(:num)'] = 'hrm/hrm/bdtask_seller_profile/$1';
/*attendance part*/
