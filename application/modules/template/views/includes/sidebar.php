...
<!-- product menu part -->
 <?php if($this->permission1->method('create_product','create')->access() || $this->permission1->method('add_product_csv','create')->access() || $this->permission1->method('manage_product','read')->access() || $this->permission1->method('create_category','create')->access() || $this->permission1->method('manage_category','read')->access() || $this->permission1->method('add_unit','create')->access() || $this->permission1->method('manage_unit','read')->access()){?>
    <li class="treeview <?php echo (($this->uri->segment(1)=="category_form" || $this->uri->segment(1)=="category_list" || $this->uri->segment(1)=="unit_form" || $this->uri->segment(1)=="unit_list" || $this->uri->segment(1)=="product_form" || $this->uri->segment(1)=="product_list" || $this->uri->segment(1)=="product_list_sp" || $this->uri->segment(1)=="product_list_rj" || $this->uri->segment(1)=="product_list_br" || $this->uri->segment(1)=="barcode" || $this->uri->segment(1)=="qrcode" || $this->uri->segment(1)=="bulk_products" || $this->uri->segment(1)=="product_details")?"active":'') ?>">
    ...
    <?php }?>
     <?php if($this->permission1->method('add_product_csv','create')->access()){ ?>
        ...
        <?php if($this->permission1->method('manage_product_sp','read')->access()){ ?>
         <li class="<?php echo (($this->uri->segment(1)=="product_list_sp")?"active":'') ?>">
                <a href="<?php echo base_url('product_list_sp') ?>">
                   
                    <?php echo display('manage_product_sp')?>
        ...
        <?php if($this->permission1->method('manage_product_rj','read')->access()){ ?>
         <li class="<?php echo (($this->uri->segment(1)=="product_list_rj")?"active":'') ?>">
                <a href="<?php echo base_url('product_list_rj') ?>">
                   
                    <?php echo display('manage_product_rj')?>
        ...
        <?php if($this->permission1->method('manage_product_br','read')->access()){ ?>
         <li class="<?php echo (($this->uri->segment(1)=="product_list_br")?"active":'') ?>">
                <a href="<?php echo base_url('product_list_br') ?>">
                   
                    <?php echo display('manage_product_br')?>
